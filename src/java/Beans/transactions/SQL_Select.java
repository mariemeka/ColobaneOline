...
//        }
    ...
    */
    ...
    public ArrayList<Client> getClientsById(String identifiant) {
        String sql = "SELECT * FROM client WHERE identifiant = '" + identifiant +"'" ;
    ...
    // Récuperer un vendeur
    public ArrayList<Vendeur> getVendeursById(String identifiant) {
        String sql = "SELECT * FROM vendeur WHERE identifiant = '" + identifiant + "'";
        
        ArrayList<Vendeur> vendeurs = new ArrayList<Vendeur>();
        try{
            this.rs=this.stmt.executeQuery(sql);
        }catch(SQLException e){
            System.out.print("Erreur d'execution de la requête "  +  e.getMessage());
        }
        String Laclasse = "Vendeur";
    ...
    public ArrayList<Article> getArticlesOfVendeur(int idvendeur) {
        String sql = "SELECT * FROM article WHERE idvendeur = " + idvendeur;
    ...
    public ArrayList<Administrateur> getAllAdmins() {
        ...
        String Laclasse = "Administrateur";
        
        admins = this.<Administrateur>RsToArrayCall(Laclasse, this.getRs());
        return admins;
    }
    
    public ArrayList<Administrateur> getAdminsById(String identifiant) {
        String sql = "SELECT * FROM administrateur WHERE identifiant = '" + identifiant + "'";
    ...
    // Get user by id
    public <T> ArrayList<T> getUserById(String identifiant, String className) {
        String sql = "SELECT * FROM " + className.toLowerCase() + " WHERE identifiant = '" + identifiant + "'";
        ...
        users = this.<T>RsToArrayCall(className, this.getRs());
        return users;
    }
