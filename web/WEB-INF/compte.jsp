						...
						<div class="checkout-form">
							...
							<form class="form" method="post" action="#">
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											<label>CodePostal <span></span></label>
					...
					<div class="col-lg-4 col-12">
						<div class="order-details">
							...
							<div class="single-widget payement">
								<div class="content">
								<img src="images/wari.jpg" alt="#" width=60 height=40>
                                                               <img src="images/om.png" alt="#" width=70 height=55>
                                                             <img src="images/w.png" alt="#" width=60 height=40>
                                                               <img src="images/wi.png" alt="#" width=60 height=40>
