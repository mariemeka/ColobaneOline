<%-- 
    Document   : Apropos
    Created on : 30 nov. 2020, 13:57:58
    Author     : Marieme ka
--%>
...
<html>
    ...
    <body>
		...
		<div class="single-slider" style="background-image: url('images/A-Propos.jpg');
        ...
        <section class="a-propos">
            <h2><strong>Qui sommes nous ?</strong></h2>
                 ...
                 <br><br>
            <p>
                Bienvenue sur ColobaneOnline<br>

                Notre mission est d’offrir à nos clients un vaste choix de produits<br>
                Notre expérience en la matière nous permet de sourcer le meilleur rapport qualité/prix pour vous.<br>
                Et nous mettons un point d’honneur à vous proposer un excellent service client et assistance.<br>
                Nous suivons de près les dernières tendances des produits du marché mondial et donnons la priorité aux envies de nos clients.<br>
                Nos clients, partout au Senegal, sont ainsi heureux de faire partie de notre communauté .<br>
                Nous espérons que vous aimerez nos produits autant que nous aimons les trouver pour vous.<br>
            </p>
            ...
            <h2><strong>Conditions Générales de ventes</strong></h2>
            
                 <br><br>
            
                
                <h6> 1 - Conclusion du contrat <br><br> </h6>
                <p>Toute commande de produits implique l'adhésion sans
                ...
                ou autres documents commerciaux. <br><br>
                </p>  
                <h6>2 - Prix <br><br> </h6>
                <p>Les marchandises sont facturées au tarif en vigueur au
                ...
                information préalable de 30 jours. <br><br>
                </p>
                <h6>3 - Livraison <br><br> </h6>
                <p>La livraison est effectuée soit par la remise directe du
                ...
                justification quant à la réalité des anomalies constatées. <br><br>
                </p>
                <h6>4 - Délais de livraison <br><br> </h6>
                <p>Les délais de livraison sont indiqués en fonction des
                ...
                indemnité que ce soit. <br><br>
                </p>
                <h6>5 - Retours <br><br> </h6>
                <p>Tout retour de produit doit faire l'objet d'un accord
                formel entre le vendeur et l'acquéreur<br><br>
                
                <h6>6 -Garantie<br><br> </h6>
                <p>Le vendeur apportera le plus grand soin à l'exécution
                ...
                dommages résultant d'un stockage, de manutention, 
                de transport ou d'utilisation dans des conditions anormales
                ou non conformes avec la nature, les prescriptions,
                l'aptitude à l'emploi du produit. .<br><br>
                </p>
                <h6>7 – Paiement<br><br> </h6>
                <p>Sauf conditions particulières, les factures sont payables
